...
export default function PersonaBody() {
  ...
  const handleStart = async () => {
    ...
    try {
      const res = await axios.post("http://localhost:5000/persona", {
        name: personName,
        about: description,
      });
    ...
    <div className=" text-white">
      <div className="w-full  ">
        <div className="flex flex-col items-center justify-end  pt-15">
          ...
          <h1 className="font-bold text-xl">
            <span className="text-3xl">PerSonaTalk</span> – TALK TO FAMOUS
            PERSONAS
          </h1>
          <div className="flex justify-center mx-5 ">
            <p className="font-semibold text-lg text-center ">
              PersonaTalk is a Generative AI-powered web application that lets
              users converse with AI personas of famous people. By combining
              real-world data from Wikipedia and the powerful capabilities of
              OpenAI’s GPT model, PersonaTalk creates intelligent,
              context-aware, and engaging conversations with historical figures,
              celebrities, scientists, and more — all simulated as if youre
              chatting directly with them.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="min-h-screen w-full   flex justify-around">
        <div className="h-md w-md relative">
          <Image src={header} alt="robot" fill className="object-contain" />
        </div>
          ...
          <div className="relative w-full h-fit max-w-xl  p-6 border border-gray-300 rounded-xl shadow-md bg-white">
            ...
            <div className="mt-5 ">
              <fieldset className="fieldset ">
                <legend className="fieldset-legend text-black">
                  Type Name of a person you want to chat with
                </legend>
                <input
                  type="text"
            ...
            <div className="mt-5 ">
              <fieldset className="fieldset ">
                ...
                <textarea
                  className="textarea h-24 text-white"
                  placeholder="He is a famous actor?(like this)"
                  value={description}
            ...
            <Link href="/persona/chat">
              <button
                className="btn bg-[#FF9900] text-black border-[#e17d00] mt-6"
                onClick={handleStart}
              >
                GET STARTED
              </button>
